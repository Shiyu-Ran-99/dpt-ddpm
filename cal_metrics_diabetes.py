...
# -------shiyu adds
dataset = 'diabetes'
o_x_train = np.load(f'data/{dataset}/X_num_train.npy')
o_x_val = np.load(f'data/{dataset}/X_num_val.npy')
o_x_test = np.load(f'data/{dataset}/X_num_test.npy')
s = np.load(f'exp/{dataset}/ddpm_cb_best/X_num_train.npy')
o_y_train = np.load(f'data/{dataset}/y_train.npy')
o_y_val = np.load(f'data/{dataset}/y_val.npy')
o_y_test = np.load(f'data/{dataset}/y_test.npy')
s_y = np.load(f'exp/{dataset}/ddpm_cb_best/y_train.npy')
